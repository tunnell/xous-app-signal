...
pub fn tls_connect_with_config(
    ...
    // Close mid-write blocks ~89 s on hardware. Refs #16. (Kept as
    // defense-in-depth alongside the xous-core services/net reaper fix that
    // is the actual root-cause cure.)
