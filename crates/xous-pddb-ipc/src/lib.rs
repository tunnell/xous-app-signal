...
//! `keystore-api`, …) — that's the workspace-merge attempt that
//! already failed at Stage 9b's first try.
//!
...
//! Stage 13b's IPC probe (commit `f7a9e7b`, asserted `is_mounted=false`
